...
const Axious_JSON = () => {
    return (
        ...
        <pre>
            ...
            주로 서버(java 백엔드)와 클라이언트(html, js, 프론트엔드) 간의 데이터 교환
           {/*{
                "표기명" : "표기내용",
                "표기명" : "표기내용",
                "표기명" : "표기내용",
                "표기명" : ["표기내용","표기내용2번","표기내용3번",...],
                "표기주소" : {
                                "도시" : "도시내용",
                                "도시번호" : "도시번호작성"
                            }
            ...
            jsonplacholder : 임시데이터로 사진이나, 포스터 내용과 같은 파일을 마늗ㄹ고 개발자들에게 무료
            */}
        ...
        Axious : 자바스크립트의 HTTP 클라이언트 라이브러리 HTTP 요청을 보내고 응답을 처리하기 위해 사용
        Promise: 성공 유무
        Fetch  : 성공 유무
